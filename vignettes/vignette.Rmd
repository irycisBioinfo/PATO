...
output:
  ...
  '': default
vignette: |
  %\VignetteIndexEntry{vignette} %\VignetteEncoding{UTF-8} %\VignetteEngine{knitr::rmarkdown}
---
...
Connected component (`cluster_modemn = 1`) uses transitive connection to cover more remote homologs.
