...
In order to compare PATO against the main pangenome analysis software we have analyzed
a different sets of *E. coli* genomes (20, 50, 100, 200, 400, 800 and 1.600 genomes).
We compared PATO against Panaroo v1.2.7 (), Peppan v1.0.5, PanX v1.5.1, 
PIRATE v1.0.4 and Roary v3.12.0. All the software, including PATO, was executed 
using default parameters. For the comparison we have used a workstation with 24 
cores (Dual Xenon) and 48Gb of RAM memory

In the case of PATO, as it is a set of functions, we create a script as close as
...
representation and accessory genome clustering).
...
![](./PATO_benchmarking.png)

PATO is clearly faster than any other software. 



Unlike the other software, 
PATO does not implement any splitting paralog processing. This makes PATO much 
faster than any of the other software. PATO was designed to analyze thousands 
of genomes and therefore during its design it was decided to dispense with the 
splitting paralogs proccess. These processes are time consuming and the results they 
often offer do not justify the excess computational time invested.

![](./PATO_bench_pansize.png)

PATO produces results very similar to Roary and PEPPAN in terms of pangenome size 
